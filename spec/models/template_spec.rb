...
# Unit tests for Ionoscloud::Template
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Ionoscloud::Template do
  let(:instance) { Ionoscloud::Template.new }

  describe 'test an instance of Template' do
    it 'should create an instance of Template' do
      expect(instance).to be_instance_of(Ionoscloud::Template)
    end
  end
