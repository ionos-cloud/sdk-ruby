...
# Unit tests for Ionoscloud::Location
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Ionoscloud::Location do
  let(:instance) { Ionoscloud::Location.new }

  describe 'test an instance of Location' do
    it 'should create an instance of Location' do
      expect(instance).to be_instance_of(Ionoscloud::Location)
    end
  end
