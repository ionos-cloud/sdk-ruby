...
# Unit tests for Ionoscloud::KubernetesNodePoolPropertiesForPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Ionoscloud::KubernetesNodePoolPropertiesForPost do
  let(:instance) { Ionoscloud::KubernetesNodePoolPropertiesForPost.new }

  describe 'test an instance of KubernetesNodePoolPropertiesForPost' do
    it 'should create an instance of KubernetesNodePoolPropertiesForPost' do
      expect(instance).to be_instance_of(Ionoscloud::KubernetesNodePoolPropertiesForPost)
    end
  end
