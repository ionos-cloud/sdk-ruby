...
# Unit tests for Ionoscloud::Resource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Ionoscloud::Resource do
  let(:instance) { Ionoscloud::Resource.new }

  describe 'test an instance of Resource' do
    it 'should create an instance of Resource' do
      expect(instance).to be_instance_of(Ionoscloud::Resource)
    end
  end
