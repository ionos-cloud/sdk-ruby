...
Source code and in depth documentation about installation and usage are available here \([https://github.com/ionos-cloud/sdk-ruby](https://github.com/ionos-cloud/sdk-ruby)\).
