  ...
  class DataCenterEntities
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Ionoscloud::DataCenterEntities` initialize method"
      end
    ...
    def hash
      [servers, volumes, loadbalancers, lans].hash
    end
